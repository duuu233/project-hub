...
| 项目 | 需求 | 交付 |
| --- | --- | --- |
| album-miniapp | ① 套餐卡赠送角标选中/未选中位置一致，只差背景色 ② 卡片右侧留白缩短（当日两次：300 → 276 → 248rpx） | c33125f、01e7b6c |
| album-app | 同上（150 → 138 → 124） | 0969685、4da1397 |
...
6. **小程序套餐卡 248rpx 已是不动主价格字号能到的下限**（内宽 216rpx，￥999999.99 约需 200rpx）。若还要更窄，得先把主价格字号从 40rpx 降到 36rpx——六位金额的要求还在，不能靠折行或省略号糊过去。APP 侧因为有 FittedBox 没有硬下限，但会越缩越小。
