...
- 实施：
  ...
  - 国内采购 / 销售自建网格 gap 24→20；角色、用户组两页的自建「440/240 定宽 + 上方标签」字段区改成 el-row/el-col；码头 / 堆场提货新增补 `zk-detail-page`（原来连 40 高都没有）；国内销售 script 在 template 前被首轮脚本漏掉，已补；帮助中心根节点 `app-container` 多一层 20 内边距（未改，框 418，差 11）。
